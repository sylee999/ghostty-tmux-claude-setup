...
Codex CLI 사용자를 위한 optional keymap 설정도 함께 제공한다.
...
./install.sh            # append/merge 방식 설치 (tmux.conf + keybindings.json + optional codex config)
```
...
- `codex-snippet.toml` — Codex CLI Shift+Enter newline optional keymap
